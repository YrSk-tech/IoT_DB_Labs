...
DROP TABLE IF EXISTS review_agency;
DROP TABLE IF EXISTS review_animator;
DROP TABLE IF EXISTS holiday;
DROP TABLE IF EXISTS agency_has_custom;
DROP TABLE IF EXISTS discounts;
DROP TABLE IF EXISTS agency;
DROP TABLE IF EXISTS custom_has_animator;
...
ENGINE = InnoDB;
ALTER TABLE custom_has_animator
...
CREATE INDEX cost_idx
ON custom(cost_in_uah);
